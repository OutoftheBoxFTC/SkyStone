...
public class HardwareConstants {
    ...
    public static final Vector2 LIFT_REST = new Vector2(SQUARE_WAVE_TO_POSITION(870), SQUARE_WAVE_TO_POSITION(820)); //The servo position for the four bar servos when in the REST position, or all the way forward. It is in the order {left, right}
    public static final Vector2 LIFT_INTAKE = new Vector2(SQUARE_WAVE_TO_POSITION(890), SQUARE_WAVE_TO_POSITION(840)); //The servo position for the four bar servos when in the INTAKE position, or the position when intaking. It is in the order {
    public static final Vector2 LIFT_FEED_OUTTAKE = new Vector2(SQUARE_WAVE_TO_POSITION(940), SQUARE_WAVE_TO_POSITION(950));
    public static final Vector2 LIFT_SCORING_POSITION = new Vector2(SQUARE_WAVE_TO_POSITION(1810), SQUARE_WAVE_TO_POSITION(1770)); //The servo position for the four bar servos when in the SCORING position. It is in the order {left, right}
    public static final Vector2 LIFT_OUT = new Vector2(SQUARE_WAVE_TO_POSITION(2015), SQUARE_WAVE_TO_POSITION(1970)); //The servo position for the four bar servos when in the OUT position, or when the arm is all the way out on the outtake side. It is in the order {left, right}
