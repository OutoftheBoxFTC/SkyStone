...
public class HardwareConstants {
    ...
    public static final Vector2 CLOSE_INTAKE = new Vector2(0.65, 1-0.70); //The servo positions for CLOSING the intake. It is in the order {left, right}
    ...
    public static final double INTAKE_LATCH_OFF = 0.2; //The servo position for the latch on the four bar lift to latch OFF of the block
    public static final Vector2 LIFT_REST = new Vector2(SQUARE_WAVE_TO_POSITION(830), SQUARE_WAVE_TO_POSITION(910)); //The servo position for the four bar servos when in the REST position, or all the way forward. It is in the order {left, right}
    public static final Vector2 LIFT_INTAKE = new Vector2(SQUARE_WAVE_TO_POSITION(935), SQUARE_WAVE_TO_POSITION(1000)); //The servo position for the four bar servos when in the INTAKE position, or the position when intaking. It is in the order {
