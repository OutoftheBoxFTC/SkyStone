...
public class HardwareConstants {
    //Servos
    public static final Vector2 LATCH_ON = new Vector2(0.1, 0.95);
    public static final Vector2 LATCH_OFF = new Vector2(0.75, 0.24);
    public static final Vector2 OPEN_INTAKE = new Vector2(0.95, 1-0.95);
    public static final Vector2 CLOSE_INTAKE = new Vector2(0.4, 1-0.4);
